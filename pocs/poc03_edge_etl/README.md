...
Spojit ETL logiku (poc01) s distribuovanou architekturou (poc02) do realistickeho scenare. Extract a transform bezi na edge workeru (linka), load bezi na centralni (serverovna). Overit prenos dat pres XCom a spravne prirazeni tasku na edge vs centralu. Implementuje **Variantu B** z [ANA-05](../analyses/ANA-05_edge_etl_flow_design.md).
...
- Vychazi z [poc01](../poc01_automotive_etl/README.md) (ETL logika) a [poc02](../poc02_edge_worker/README.md) (Edge Worker)
