...
Vychazi z [poc3](../poc3_edge_etl/README.md) (Edge ETL Varianta B).
...
### edge_automotive_etl (z poc3)
Edge ETL workflow — extract+transform na lince, load na centrale. Viz [poc3](../poc3_edge_etl/README.md).
...
Pozn: Pouzivat CLI trigger, ne REST API — viz [troubleshooting](../poc1_automotive_etl/analyses/ANA-01_troubleshooting.md).

## Navaznost

- Vychazi z [poc3](../poc3_edge_etl/README.md) (Edge ETL)
