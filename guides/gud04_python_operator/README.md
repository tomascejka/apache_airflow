# gud04: PythonOperator a TaskFlow API

## Popis

Demonstrace dvou zpusobu psani Python tasku v Airflow: klasicky PythonOperator a moderni TaskFlow API (@task dekorator). Navazuje na gud03 (BashOperator).
